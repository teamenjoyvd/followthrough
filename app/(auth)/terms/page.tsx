  ...
  return (
    <main className="min-h-screen bg-white px-6 py-12">
      <div className="mx-auto max-w-3xl prose prose-gray">
        ...
        <p>
          These Legal Terms constitute a legally binding agreement between you and us concerning your
          access to and use of the Services. By accessing the Services, you have read, understood, and
        ...
        <p>
          We reserve the right to make changes or modifications to these Legal Terms at any time and
          for any reason. We will alert you about any changes by updating the &ldquo;Last updated&rdquo; date. It
        ...
        <p>
          ...
          be contrary to law or regulation. Those who choose to access the Services from other
        ...
        <p>
          ...
          video, text, photographs, and graphics (collectively, the &ldquo;Content&rdquo;), as well as the
          trademarks, service marks, and logos contained therein (the &ldquo;Marks&rdquo;).
        </p>
        <p>
          Our Content and Marks are protected by copyright and trademark laws and treaties around the
          world. The Content and Marks are provided through the Services &ldquo;AS IS&rdquo; for your personal,
        ...
        <p>
          ...
          non-transferable, revocable license to access the Services and download or print a copy of
          any portion of the Content to which you have properly gained access, solely for your
        ...
        <p>
          ...
          idea, feedback, or other information about the Services (&ldquo;Submissions&rdquo;), you agree to assign
        ...
        <p>
          ...
          threatening, sexually explicit, false, inaccurate, deceitful, or misleading. You are solely
          responsible for your Submissions and you expressly agree to reimburse us for any and all
          losses that we may suffer because of your breach of this section, any third party&apos;s
        ...
        <ul>
          ...
          <li>
            Upload or transmit viruses, Trojan horses, or other material that interferes with any
        ...
        <p>
          ...
          Contributions or any portion thereof; (4) remove from the Services or otherwise disable all
          files and content that are excessive in size or are in any way burdensome to our systems;
          and (5) otherwise manage the Services in a manner designed to protect our rights and
          property.
        </p>
        ...
        <p>
          ...
          TO AND USE OF THE SERVICES TO ANY PERSON FOR ANY REASON, INCLUDING WITHOUT LIMITATION FOR
        ...
        <p>
          ...
          third party. We reserve the right to take appropriate legal action, including without
        ...
        <p>
          ...
          Services, resulting in interruptions, delays, or errors. Nothing in these Legal Terms will
        ...
        <p>
          ...
          to these Legal Terms, the Parties agree to first attempt to negotiate any Dispute informally
        ...
        <p>
          ...
          by binding arbitration. The Parties agree that any arbitration shall be limited to the
          Dispute between the Parties individually.
        </p>
        <h3>Exceptions to Informal Negotiations and Arbitration</h3>
        <p>
          The Parties agree that the following Disputes are not subject to the above provisions: (a)
        ...
        <p>
          ...
          PARTICULAR PURPOSE, AND NON-INFRINGEMENT. WE DO NOT WARRANT, ENDORSE, GUARANTEE, OR ASSUME
        ...
        <p>
          ...
          CERTAIN STATE LAWS AND INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR
        ...
        <p>
          ...
          the performance of the Services. Although we perform regular routine backups of data, you
          are solely responsible for all data that you transmit or that relates to any activity you
        ...
        <p>
          ...
          permissible by law. If any provision or part of a provision of these Legal Terms is
          determined to be unlawful, void, or unenforceable, that provision is deemed severable from
